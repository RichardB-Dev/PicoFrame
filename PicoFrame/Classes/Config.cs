    ...
    public class Config
    {
        ...
        public void LoadAppConfig()
        {
            if (!File.Exists(AppPath + @"AppConfig.json")) // Create Config JSON file if does not exist
            {
                ...
                CreateShortcut("PicoFrame_Shortcut", windowsStartUpFolder, AppDomain.CurrentDomain.BaseDirectory + @"\PicoFrame.exe"); // Create start up shortcut
        ...
        public static void CreateShortcut(string shortcutName, string shortcutPath, string targetFileLocation)
        {
            ...
            shortcut.Description = "Pico Frame";   // The description of the shortcut
